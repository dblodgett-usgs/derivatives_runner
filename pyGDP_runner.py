...
dataURIs=['http://localhost:8080/thredds/dodsC/Striped/derivatives/ncml/longest_run_tmax_abv_cmip5_der.ncml',
          ...
          'http://localhost:8080/thredds/dodsC/Striped/derivatives/ncml/growing_degree_day_cmip5_der.ncml',
          ...
          'http://localhost:8080/thredds/dodsC/Striped/derivatives/ncml/growing_degree_day_cmip5_hist_der.ncml',
...
for dataURI in dataURIs:
    remote_dataURI=dataURI.replace('http://localhost:8080/thredds/dodsC/Striped/derivatives/ncml/','http://cida.usgs.gov/thredds/dodsC/cmip5_bcca/derivatives/ncml/')
    ...
    for shapefile in shapefiles.keys():
        outputfilename=shapefile.replace('derivative:','')+'_'+dataURI.replace('http://localhost:8080/thredds/dodsC/Striped/derivatives/ncml/','')
