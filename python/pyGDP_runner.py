...
# "http://localhost:8080/thredds/dodsC/temp/averages/ncml/averages_annual.ncml",
# 		  "http://localhost:8080/thredds/dodsC/temp/averages/ncml/averages_seasonal.ncml",
# 		  "http://localhost:8080/thredds/dodsC/temp/averages/ncml/averages_monthly.ncml"]

#'http://localhost:8080/thredds/dodsC/Scratch/thredds/bcca/bcca/cmip5/derivatives/ncml/longest_run_tmax_abv_cmip5_der.ncml',
...
for dataURI in dataURIs:
    ...
    if 'averages' in dataURI:
        remote_dataURI=dataURI.replace('http://localhost:8080/thredds/dodsC/temp/averages/ncml/','http://cida-eros-thredds3.er.usgs.gov:8080/thredds/dodsC/cmip5_bcca/derivatives/ncml/')
    ...
    for shapefile in shapefiles.keys():
        outputfilename=shapefile.replace('derivative:','')+'_'+dataURI.replace('http://localhost:8080/thredds/dodsC/Scratch/thredds/bcca/bcca/cmip5/derivatives/ncml/','').replace('http://localhost:8080/thredds/dodsC/temp/averages/ncml/','').replace('http://localhost:8080/thredds/dodsC/Scratch/thredds/bcca/bcca/cmip5/derivatives/cmip5_obs_der/','')
